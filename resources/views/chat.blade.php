                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="chat-about">
                                        <h6 class="m-b-0">{{ $mentor->name }}</h6>
                                        {{-- <small>Last seen: 2 hours ago</small> --}}
                                    </div>
                                </div>
                                {{-- <div class="text-right col-lg-6 hidden-sm"> --}}
...
@endif
                        ...
                        @endif
                            <form action="{{ route('startdialogue') }}" method="post">
                                @csrf
                                <div class="mb-0 input-group">
                                    <div class="input-group-prepend">

                                    </div>
                                    <input type="hidden" value="{{ $allchast->id }}" name="chat_id" id="">
                                    ...
                                    <button type="submit" class="btn btn-primary">  <span ><i class="fa fa-send"></i></span> Send Message</button>
                                </div>
                            </form>
